...
#include "vm_version_ext_riscv32.hpp"
...
void VM_Version_Ext::initialize_cpu_information(void) {
  ...
  snprintf(_cpu_name, CPU_TYPE_DESC_BUF_SIZE - 1, "Riscv32");
  snprintf(_cpu_desc, CPU_DETAILED_DESC_BUF_SIZE, "Riscv32 %s", _features_string);
  _initialized = true;
}
