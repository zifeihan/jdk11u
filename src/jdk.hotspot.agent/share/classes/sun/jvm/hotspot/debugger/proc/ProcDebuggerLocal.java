...
import sun.jvm.hotspot.debugger.proc.riscv32.*;
...
public class ProcDebuggerLocal extends DebuggerBase implements ProcDebugger {
    ...
    public ProcDebuggerLocal(MachineDescription machDesc, boolean useCache) {
        ...
        if (cpu.equals("sparc")) {
            ...
            threadFactory = new ProcRISCV32ThreadFactory(this);
            pcRegIndex = RISCV32ThreadContext.PC;
            fpRegIndex = RISCV32ThreadContext.FP;
