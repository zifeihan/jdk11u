...
#ifdef riscv32
#include "sun_jvm_hotspot_debugger_riscv32_RISCV32ThreadContext.h"
#endif
...
#if defined(i386) || defined(amd64) || defined(sparc) || defined(sparcv9) || defined(ppc64) || defined(ppc64le) || defined(aarch64) || defined(riscv32)
...
#endif
#ifdef riscv32
#define NPRGREG sun_jvm_hotspot_debugger_riscv32_RISCV32ThreadContext_NPRGREG
#endif
#if defined(sparc) || defined(sparcv9)
...
#define REG_INDEX(reg) sun_jvm_hotspot_debugger_riscv32_RISCV32ThreadContext_##reg
